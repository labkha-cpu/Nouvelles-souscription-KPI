/* GENERATED 2025-12-09 16:39:02.673053 | SOURCE: 06122025 | NB: 21 */
...
FROM (
  ...
  WHERE usr.realm_id != 'master'
    ...
    AND (
      (attmiddle.value ILIKE 'BARMOY' AND att2.value = '2000-08-05')
      OR (attmiddle.value ILIKE 'BOIVIN' AND att2.value = '1987-05-05')
      OR (attmiddle.value ILIKE 'BOULEZ' AND att2.value = '1982-06-02')
      OR (attmiddle.value ILIKE 'CAPIZZI' AND att2.value = '1973-08-04')
      OR (attmiddle.value ILIKE 'CHAPU' AND att2.value = '2002-04-08')
      OR (attmiddle.value ILIKE 'CUVILLIER' AND att2.value = '1974-03-04')
      OR (attmiddle.value ILIKE 'DASSUNCAO' AND att2.value = '2000-07-04')
      OR (attmiddle.value ILIKE 'DEL-BONTA' AND att2.value = '2001-10-08')
      OR (attmiddle.value ILIKE 'DEMARET' AND att2.value = '1970-01-03')
      OR (attmiddle.value ILIKE 'DUBOIS' AND att2.value = '1973-05-01')
      OR (attmiddle.value ILIKE 'FELLRATH' AND att2.value = '1973-12-02')
      OR (attmiddle.value ILIKE 'GALIA' AND att2.value = '2002-10-07')
      OR (attmiddle.value ILIKE 'HUSSON' AND att2.value = '1982-10-12')
      OR (attmiddle.value ILIKE 'LAUDON' AND att2.value = '1970-01-05')
      OR (attmiddle.value ILIKE 'LOMBARDO' AND att2.value = '1966-01-05')
      OR (attmiddle.value ILIKE 'MAKOBA' AND att2.value = '1989-10-05')
      OR (attmiddle.value ILIKE 'NADEAU' AND att2.value = '1979-09-05')
      OR (attmiddle.value ILIKE 'PETITGENET' AND att2.value = '2000-02-01')
      OR (attmiddle.value ILIKE 'RYCKEBUSCH' AND att2.value = '1979-05-08')
      OR (attmiddle.value ILIKE 'SAID MOHAMED' AND att2.value = '1981-10-07')
      OR (attmiddle.value ILIKE 'SOURTY' AND att2.value = '1970-02-01')
    )
